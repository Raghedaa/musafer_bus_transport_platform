  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            _buildLoc("FROM", searchController.origin.value, CrossAxisAlignment.start),            Expanded(
              child: Column(
                children: [
            ...
            _buildLoc("TO", searchController.destination.value, CrossAxisAlignment.end),          ],
        ),
      ),
    );
  }
  ...
  Widget _buildLoc(String label, String city, CrossAxisAlignment align) {
    return Column(
      ...
      children: [
        ...
        Text(city, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15.sp)),
      ],
    );
  }
}